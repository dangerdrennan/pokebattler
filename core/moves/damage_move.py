...
from core.enums.pokemon_type import PokemonType, TYPE_OFFENSIVE_MULTIPLIERS
...
class DamageMove(MoveInterface):
    ...
    def apply_secondary_effect(self, target: Pokemon):
    ...
    def apply_move(self, attacker: Pokemon, targets: List[Pokemon]) -> None:
        ...
        for i in range(len(results_list)):
            if results_list[i]:
                ...
                ## set status to fainted before applying secondary affect
